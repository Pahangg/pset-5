...
const drawRectangle = function() {
  const drawing1 = document.getElementById('student-canvas-2');
   const ctx = drawing1.getContext('2d');
   ctx.clearRect(0, 0, drawing1.width, drawing1.height);
...
const drawTriangle = function() {
  const drawing3 = document.getElementById('student-canvas-4');
    const ctx = drawing3.getContext('2d');
    ctx.clearRect(0, 0, drawing3.width, drawing3.height);
...
const drawFace = function() {
  ...
  const drawing4 = document.getElementById('student-canvas-5');
    const ctx = drawing4.getContext('2d');
    ctx.clearRect(0, 0, drawing4.width, drawing4.height);
